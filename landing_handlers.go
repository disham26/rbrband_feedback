...
//Index2Handler is the first function for the landing page
func Index2Handler(session *mgo.Session) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		session := mongoSession.Copy()
		defer session.Close()
		...
		t.ExecuteTemplate(w, "super_home", page)
		return
	}
}
